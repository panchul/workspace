...
# Content
 ...
 - [Installing](Linux.md#installing)
   - [Installing using USB](Linux.md#installing-using-usb)
   - [Install .rpm File](Linux.md#install-rpm-file-on-linuxcentos-fedora-etc)
...
Had something wrong with `grub` on a vm, needed
to run `sudo dpkg --configure -a` to get
...
1. du in megabytes.
2. sorting with numeric mode.
3. last 100 lines of the output.
...
Now where the [Kafka](Kafka.md) is:
