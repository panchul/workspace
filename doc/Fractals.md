...
- [Cellular Automata Fractals](Fractals.md#cellular-automata-fractals)
- [Mandelbrot fractals](Fractals.md#mandelbrot-fractals)
...
I tinkered with cellular automata since 90s or even ealier.

```
from my old notebook and print-outs,
  I had this one:
  41     10        3311100320
  with starting points of 1, 23, 11

also, 3211310(5) with starting 1
      12001120(3) 1
```

looked up 2017/04/01: http://web.mit.edu/outland/src/xmfract_1.4/help/help.118
...
(r). Xmfract implements the binary nearest neighbor cellular automata
...
"Computer Software in Science and Mathematics", Stephen Wolfram,
